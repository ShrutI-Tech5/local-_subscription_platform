...
import { SERVICE_TYPES } from '../utils/mockData';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        navigate('/verify-otp', { state: { email: formData.email, role: 'provider' } });
      } else {
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 p-4">
      <div className="max-w-2xl mx-auto pt-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <h1 className="text-3xl mb-2 text-gray-900">Service Provider Registration</h1>
          <p className="text-gray-600 mb-8">Join our platform and grow your business</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block mb-2 text-gray-700">ID Proof (Optional)</label>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <p className="text-sm text-yellow-800">
                <strong>Note:</strong> Your account will be activated immediately. In a production environment, admin approval would be required.
              </p>
            </div>
